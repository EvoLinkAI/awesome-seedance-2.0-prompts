...
> 探索更广泛的 Seedance 2.0 生态：
>
> API 文档与集成参考: [`EvoLinkAI/Seedance-2.0-API`](https://github.com/EvoLinkAI/Seedance-2.0-API)
>
> OpenClaw 工作流集成: [`EvoLinkAI/seedance2-video-gen-skill-for-openclaw`](https://github.com/EvoLinkAI/seedance2-video-gen-skill-for-openclaw)
>
> 端到端使用指南与示例: [`EvoLinkAI/awesome-seedance-2-guide`](https://github.com/EvoLinkAI/awesome-seedance-2-guide)
...
**[立即试用 ->](https://evolink.ai/seedance-2-0?utm_source=github&utm_medium=readme&utm_campaign=awesome-seedance-2-0-prompts)**
...
### 提示词 43
![Language-EN](https://img.shields.io/badge/Language-EN-blue?style=flat-square)
“第一人称 POV 骑马镜头，冲过一片被雾气笼罩的中世纪战场。画面底部可见马匹的黑色鬃毛和耳朵……”

来源: [Post](https://x.com/simple__dev/status/2039935077912826240) · 发布日期: 2026年4月3日
...
来源: [Post](https://x.com/BarlowHakusyaku/status/2040673309181018522) · 发布日期: 2026年4月5日
...
来源: [Post](https://x.com/mikeymansta/status/2040380590818730418) · 发布日期: 2026年4月4日
